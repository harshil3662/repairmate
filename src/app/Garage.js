    ...
    <div className='container-fluid'>
      ...
      <div className='garage col mt-4'>
        ...
        <div className='row m-4'>
          ...
          <div className='col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-xxl-0 mt-xl-0 mt-lg-0 mt-md-4 mt-sm-4 mt-4 d-flex justify-content-center align-items-center'>
            <form className='form p-4'>
              <div className="input-group-lg m-2">
                <input id='name' name='name' type="text" className="form-control" placeholder='Enter your name' autocomplete="off" />
              </div>
              <div className="input-group-lg m-2">
                <input id='car' name='car' type="text" className="form-control" placeholder='Enter car name & model' autocomplete="off"/>
              </div>
              <div onClick={()=>{}} className='p-3 border rounded d-flex justify-content-between align-items-center m-2'>
        ...
        <div className='row m-4 border-top p-5'>
